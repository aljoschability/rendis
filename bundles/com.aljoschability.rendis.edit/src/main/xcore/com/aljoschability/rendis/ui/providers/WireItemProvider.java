    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Wire_cubicle_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Wire_cubicle_feature", "_UI_Wire_type"),
         RendisPackage.Literals.WIRE__CUBICLE,
         true,
         false,
         true,
         null,
  ...
  protected void addChannelPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Wire_channel_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Wire_channel_feature", "_UI_Wire_type"),
         RendisPackage.Literals.WIRE__CHANNEL,
         true,
         false,
         true,
         null,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         RendisPackage.Literals.WIRE__TARGET,
         true,
         false,
         true,
         null,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         RendisPackage.Literals.WIRE__SOURCE,
         true,
         false,
         true,
         null,
  ...
  protected void addCrossSectionPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Wire_crossSection_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Wire_crossSection_feature", "_UI_Wire_type"),
         RendisPackage.Literals.WIRE__CROSS_SECTION,
         true,
         false,
         false,
