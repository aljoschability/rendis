 ...
 * @generated
 */
public class CubicleItemProvider extends ChannelNodeItemProvider {
	/**
	...
	protected void addBuildingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				RendisPackage.Literals.CUBICLE__BUILDING, true, false, true, null, null, null));
	}
	...
	protected void addFloorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				RendisPackage.Literals.CUBICLE__FLOOR, true, false, true, null, null, null));
	}
	...
	protected void addRoomPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				RendisPackage.Literals.CUBICLE__ROOM, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Cubicle_type") : //$NON-NLS-1$
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RendisPackage.Literals.CUBICLE__DEVICES,
		...
		newChildDescriptors.add(createChildParameter(RendisPackage.Literals.CUBICLE__WIRES,
