 ...
 * @generated
 */
public class CircuitBreakerItemProvider extends CubicleDeviceItemProvider {
	/**
	...
	protected void addRatedCurrentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_CircuitBreaker_ratedCurrent_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_CircuitBreaker_ratedCurrent_feature", "_UI_CircuitBreaker_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						RendisPackage.Literals.CIRCUIT_BREAKER__RATED_CURRENT, true, false, false,
	...
	protected void addCharacteristicPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_CircuitBreaker_characteristic_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_CircuitBreaker_characteristic_feature", "_UI_CircuitBreaker_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						RendisPackage.Literals.CIRCUIT_BREAKER__CHARACTERISTIC, true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CircuitBreaker")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_CircuitBreaker_type") : //$NON-NLS-1$
				getString("_UI_CircuitBreaker_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
