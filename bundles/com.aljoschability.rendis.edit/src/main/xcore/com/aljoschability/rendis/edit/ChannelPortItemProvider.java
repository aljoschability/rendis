 ...
 * @generated
 */
public class ChannelPortItemProvider extends NamedItemProvider {
	/**
	...
	protected void addNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_ChannelPort_node_feature", "_UI_ChannelPort_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						RendisPackage.Literals.CHANNEL_PORT__NODE, true, false, true, null, null, null));
	}
	...
	protected void addIncomingPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_ChannelPort_incoming_feature", "_UI_ChannelPort_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						RendisPackage.Literals.CHANNEL_PORT__INCOMING, true, false, true, null, null, null));
	}
	...
	protected void addOutgoingPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_ChannelPort_outgoing_feature", "_UI_ChannelPort_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						RendisPackage.Literals.CHANNEL_PORT__OUTGOING, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ChannelPort_type") : //$NON-NLS-1$
