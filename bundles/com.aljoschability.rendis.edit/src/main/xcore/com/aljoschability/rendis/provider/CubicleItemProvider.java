    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Cubicle_building_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Cubicle_building_feature", "_UI_Cubicle_type"),
  ...
  protected void addFloorPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Cubicle_floor_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Cubicle_floor_feature", "_UI_Cubicle_type"),
  ...
  protected void addRoomPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Cubicle_room_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Cubicle_room_feature", "_UI_Cubicle_type"),
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/Cubicle"));
  }
  ...
  public String getText(Object object)
  {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_Cubicle_type") :
      getString("_UI_Cubicle_type") + " " + label;
  }
