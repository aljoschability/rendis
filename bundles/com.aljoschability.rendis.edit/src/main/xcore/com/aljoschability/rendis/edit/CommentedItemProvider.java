 ...
 * @generated
 */
public class CommentedItemProvider extends NamedItemProvider {
	/**
	...
	protected void addCommentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_Commented_comment_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Commented_comment_feature", "_UI_Commented_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				RendisPackage.Literals.COMMENTED__COMMENT, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Commented_type") : //$NON-NLS-1$
				getString("_UI_Commented_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
