 ...
 * @generated
 */
public class DistributionBoxItemProvider extends DistributorItemProvider {
	/**
	...
	protected void addMountingPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_DistributionBox_mounting_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_DistributionBox_mounting_feature", "_UI_DistributionBox_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						RendisPackage.Literals.DISTRIBUTION_BOX__MOUNTING, true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DistributionBox")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_DistributionBox_type") : //$NON-NLS-1$
				getString("_UI_DistributionBox_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
