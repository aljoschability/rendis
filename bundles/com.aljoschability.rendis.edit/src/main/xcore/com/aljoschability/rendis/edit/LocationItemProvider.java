...
import com.aljoschability.rendis.Location;
...
/**
 * This is the item provider adapter for a {@link com.aljoschability.rendis.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationItemProvider extends CommentedItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RendisPackage.Literals.LOCATION__DISTRIBUTORS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case RendisPackage.LOCATION__DISTRIBUTORS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RendisPackage.Literals.LOCATION__DISTRIBUTORS,
				RendisFactory.eINSTANCE.createDistributionBox()));
	}
