    ...
    IItemPropertySource
{
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/StairwaySwitchTimer"));
  }
  ...
  public String getText(Object object)
  {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_StairwaySwitchTimer_type") :
      getString("_UI_StairwaySwitchTimer_type") + " " + label;
  }
