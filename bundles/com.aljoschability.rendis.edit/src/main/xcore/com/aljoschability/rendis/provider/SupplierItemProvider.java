    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Supplier_residence_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Supplier_residence_feature", "_UI_Supplier_type"),
         RendisPackage.Literals.SUPPLIER__RESIDENCE,
         true,
         false,
         true,
         null,
