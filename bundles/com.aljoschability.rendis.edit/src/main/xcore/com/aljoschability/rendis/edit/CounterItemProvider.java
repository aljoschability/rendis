...
/**
 * This is the item provider adapter for a {@link com.aljoschability.rendis.Counter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CounterItemProvider extends CubicleDeviceItemProvider {
	/**
	...
	protected void addRatedCurrentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_Counter_ratedCurrent_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Counter_ratedCurrent_feature", "_UI_Counter_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						RendisPackage.Literals.COUNTER__RATED_CURRENT, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Counter_type") : //$NON-NLS-1$
	...
	public void notifyChanged(Notification notification) {
		...
		case RendisPackage.COUNTER__RATED_CURRENT:
