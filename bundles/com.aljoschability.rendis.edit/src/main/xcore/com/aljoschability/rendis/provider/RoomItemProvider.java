    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Room_floor_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Room_floor_feature", "_UI_Room_type"),
  ...
  protected void addBuildingPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Room_building_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Room_building_feature", "_UI_Room_type"),
