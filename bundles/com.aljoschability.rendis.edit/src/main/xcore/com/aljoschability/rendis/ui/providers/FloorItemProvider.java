    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Floor_building_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Floor_building_feature", "_UI_Floor_type"),
  ...
  public String getText(Object object)
  {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_Floor_type") :
      getString("_UI_Floor_type") + " " + label;
  }
