 ...
 * @generated
 */
public class TransformatorItemProvider extends CubicleDeviceItemProvider {
	/**
	...
	protected void addOutputVoltagesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_Transformator_outputVoltages_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Transformator_outputVoltages_feature", "_UI_Transformator_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						RendisPackage.Literals.TRANSFORMATOR__OUTPUT_VOLTAGES, true, false, false,
	...
	protected void addOutputAmperesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_Transformator_outputAmperes_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Transformator_outputAmperes_feature", "_UI_Transformator_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						RendisPackage.Literals.TRANSFORMATOR__OUTPUT_AMPERES, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Transformator")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Transformator_type") : //$NON-NLS-1$
				getString("_UI_Transformator_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
