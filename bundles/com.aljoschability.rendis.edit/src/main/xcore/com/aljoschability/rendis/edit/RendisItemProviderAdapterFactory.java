 ...
 * @generated
 */
public class RendisItemProviderAdapterFactory extends RendisAdapterFactory implements ComposeableAdapterFactory,
	...
	public void dispose() {
		if (residenceItemProvider != null)
			residenceItemProvider.dispose();
		if (supplierItemProvider != null)
			supplierItemProvider.dispose();
		if (buildingItemProvider != null)
			buildingItemProvider.dispose();
		if (channelPortItemProvider != null)
			channelPortItemProvider.dispose();
		if (channelItemProvider != null)
		...
		if (cubicleItemProvider != null)
			cubicleItemProvider.dispose();
		if (residualCurrentProtectiveDeviceItemProvider != null)
			residualCurrentProtectiveDeviceItemProvider.dispose();
		if (circuitBreakerItemProvider != null)
			circuitBreakerItemProvider.dispose();
		if (counterItemProvider != null)
			counterItemProvider.dispose();
		if (stairwaySwitchTimerItemProvider != null)
			stairwaySwitchTimerItemProvider.dispose();
		if (transformatorItemProvider != null)
			transformatorItemProvider.dispose();
		if (wirePortItemProvider != null)
			wirePortItemProvider.dispose();
		if (wireItemProvider != null)
			wireItemProvider.dispose();
		if (distributionBoxItemProvider != null)
			distributionBoxItemProvider.dispose();
		if (deviceItemProvider != null)
			deviceItemProvider.dispose();
		if (offSwitchItemProvider != null)
			offSwitchItemProvider.dispose();
		if (toggleSwitchItemProvider != null)
			toggleSwitchItemProvider.dispose();
		if (intermediateSwitchItemProvider != null)
			intermediateSwitchItemProvider.dispose();
		if (twoCircuitSwitchItemProvider != null)
			twoCircuitSwitchItemProvider.dispose();
		if (retractiveSwitchItemProvider != null)
			retractiveSwitchItemProvider.dispose();
		if (powerSocketItemProvider != null)
			powerSocketItemProvider.dispose();
	}
