    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Counter_ratedCurrent_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Counter_ratedCurrent_feature", "_UI_Counter_type"),
         RendisPackage.Literals.COUNTER__RATED_CURRENT,
         true,
         false,
         false,
