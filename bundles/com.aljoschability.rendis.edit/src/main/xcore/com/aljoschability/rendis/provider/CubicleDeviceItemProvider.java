 ...
 * @generated
 */
public class CubicleDeviceItemProvider
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_CubicleDevice_cubicle_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_CubicleDevice_cubicle_feature", "_UI_CubicleDevice_type"),
         RendisPackage.Literals.CUBICLE_DEVICE__CUBICLE,
         true,
         false,
         true,
         null,
  ...
  public String getText(Object object)
  {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_CubicleDevice_type") :
      getString("_UI_CubicleDevice_type") + " " + label;
  }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (RendisPackage.Literals.CUBICLE_DEVICE__INCOMINGS,
         RendisFactory.eINSTANCE.createWirePort()));

    newChildDescriptors.add
      (createChildParameter
        (RendisPackage.Literals.CUBICLE_DEVICE__OUTGOINGS,
         RendisFactory.eINSTANCE.createWirePort()));
  }
